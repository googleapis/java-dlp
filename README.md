...
```Groovy
implementation 'com.google.cloud:google-cloud-dlp:3.0.7'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-dlp" % "3.0.7"
```
...
Samples are in the [`samples/`](https://github.com/googleapis/java-dlp/tree/master/samples) directory.
